...
- Configurable local raw-API agent runtimes for OpenAI-compatible providers, Anthropic, and Google GenAI, with provider-first session state persisted under `~/.codealta/machine/agents/` (`CodeAlta`, `CodeAlta.Agent.*`, `CodeAlta.Catalog`)
