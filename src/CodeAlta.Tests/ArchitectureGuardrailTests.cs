...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ThreadRuntimeEventCoordinator.cs:98:_ = ObservePluginAgentEventAsync(thread, agentRuntimeEvent.Event);",
            "App/ThreadRuntimeEventCoordinator.cs:114:_ = ObservePluginAgentEventAsync(thread, @event);",
            "App/ThreadRuntimeEventCoordinator.cs:180:_ = InvalidateProjectFileSearchAsync(thread.WorkingDirectory);",
